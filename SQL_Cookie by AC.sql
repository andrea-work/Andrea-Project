...
---------------------------------------------------------------------------------------
-- 4. Insert value to column to the new column just created
...
---------------------------------------------------------------------------------------
-- **9. Total Units Sold by Product(Cookie) Types? (This information may be useful for the sales/marketing, marmanufactory, inventory, and etc. )
-- -- GROUP BY normally reduces the number of rows returned by rolling them up and calculating averages or sums for each row. So need to show DISTINCT
...
Select Distinct Product,Sum(UnitsSold) As TotalUnitsSold
From CookieOrder
Group By Product
Order By 2 Desc
...
Order By 2 Desc
---------------------------------------------------------------------------------------
-- 10. Max Units of Cookie sold that day? (This information may be useful for the marketing, manufactory and inventory.)
